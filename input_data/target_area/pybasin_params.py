...
print("-" * 10)
print("Example PyBasin dataset == target_area === ")
print("Численное исследование потенциальной зоны поиска решения === ")
print("-" * 10)
...
class ModelParameters:
    ...
    output_dir = "model_output/target_area"
    ...
    datafile_output_dir = "model_output/target_area/thermal_history_datafiles"
    ...
    exhumation_period_starts = [90.0]  # или 85.0
    exhumation_period_ends = [65.0]
